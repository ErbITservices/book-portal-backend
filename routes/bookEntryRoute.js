...
const { addBookEntryController, getBookEntryController, getAllBookEntryController, gettest, deleteBoolEntryController, putBoolEntryController, getScheamBookController } = require('../controllers/bookEntryController');

router.post("/addBook",addBookEntryController);
router.get("/getBook/:userId/:schemename", getBookEntryController);
router.get("/getScheamBook/:schemename", getScheamBookController);
